...
export function screenToWorld(pos, options) {
    var _a, _b, _c;
    ...
    return new Vector2((pos.x - offset.x) * zoom + center.x, (pos.y - offset.y) * zoom + center.y);
}
export function worldToScreen(pos, options) {
    var _a, _b, _c;
    const center = (_a = options === null || options === void 0 ? void 0 : options.center) !== null && _a !== void 0 ? _a : { x: 0, y: 0 };
    const offset = (_b = options === null || options === void 0 ? void 0 : options.offset) !== null && _b !== void 0 ? _b : { x: 0, y: 0 };
    const zoom = (_c = options === null || options === void 0 ? void 0 : options.zoom) !== null && _c !== void 0 ? _c : 1;
    return new Vector2((pos.x + offset.x) * zoom + (center.x / zoom), (pos.y + offset.y) * zoom + (center.y / zoom));
}
