...
class ChainableCanvas {
    ...
    image(image, fromPos, toPos = this.recentConfig.rect) {
        render_js_1.CanvasRender.Image(this.ctx, image, fromPos, toPos);
        return this;
    }
    imageFrom(image, fromPos) {
        render_js_1.CanvasRender.Image(this.ctx, image, this.recentConfig.rect, fromPos);
        return this;
    }
    text(text) {
    ...
    circle(override) {
        ...
        render_js_1.CanvasRender.circle(this.ctx, Object.assign({ x,
            y, radius: w }, override));
        return this;
    }
    ...
    get merge() {
        ...
        render_js_1.CanvasRender.Image(prev.ctx, r.canvas, undefined, prev.rect);
        return this.restore;
    }
    get save() {
        this.ctx.save();
...
class BrushCanvas {
    ...
    center() {
        return new vector_1.Vector2(this.width / 2, this.height / 2);
    }
    focus() {
