...
class Engine {
    ...
    screenToWorld(pos, options) {
        ...
        pos.x - 5;
        return new vector_1.Vector2((pos.x - this.offset.x) * this.zoom + center.x, (pos.y - this.offset.y) * this.zoom + center.y);
    }
    worldToScreen(pos, options) {
        const center = (options === null || options === void 0 ? void 0 : options.center) === true ? this.brush.center() : { x: 0, y: 0 };
        return new vector_1.Vector2((pos.x / this.zoom - this.offset.x) - center.x / this.zoom, (pos.y / this.zoom - this.offset.y) - center.y / this.zoom);
    }
    get objectGroup() {
