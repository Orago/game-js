        ...
        for (const gamepad of gamepads) {
            ...
            if (index < 0) {
                if (difference(gamepad.axes[0], 0) > minimum) {
                    ...
                    else if (action == "Left-Axis-Left" &&
                        gamepad.axes[0] < 0) {
                        return true;
                    }
                    else if (action == "Left-Axis-Right" &&
                        gamepad.axes[0] > 0) {
                        return true;
                    }
                }
                if (difference(gamepad.axes[1], 0) > minimum) {
                    ...
                    else if (action == "Left-Axis-Up" &&
                        gamepad.axes[1] < 0) {
                        return true;
                    }
                    else if (action == "Left-Axis-Down" &&
                        gamepad.axes[1] > 0) {
                        return true;
                    }
                }
                if (difference(gamepad.axes[2], 0) > minimum) {
                    ...
                    else if (action == "Right-Axis-Left" &&
                        gamepad.axes[2] < 0) {
                        return true;
                    }
                    else if (action == "Right-Axis-Right" &&
                        gamepad.axes[2] > 0) {
                        return true;
                    }
                }
                if (difference(gamepad.axes[3], 0) > minimum) {
                    ...
                    else if (action == "Right-Axis-Up" &&
                        gamepad.axes[3] < 0) {
                        return true;
                    }
                    else if (action == "Right-Axis-Down" &&
                        gamepad.axes[3] > 0) {
                        return true;
                    }
                }
