...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./brush/brush.js", "./util/image-packer.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Textures = exports.TextureSheet = exports.Spritesheet = void 0;
    ...
    class Sprites {
        ...
        constructor(options) {
            this.canvas = new brush_js_1.default().chainable;
            /**
        ...
        promise(url) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                url = this.parseUrl(url);
                return (_b = (_a = this.cache.get(url)) === null || _a === void 0 ? void 0 : _a.img) !== null && _b !== void 0 ? _b : (yield this.loadSinglePromise(url));
                // const cached = this.cache.get(url);
                // return cached ? cached.img : await this.loadSinglePromise(url);
            });
        }
    }
    Sprites.Slice = Sprites.slice;
    ...
    class TextureSheet {
        ...
        set(list) {
            ...
            const result = image_packer_js_1.ImagePacker.pack(this.texture, this.ctx, boxes, 1);
            this.sprites.clear();
        ...
        getImage(id) {
            var _a;
            const [x, y, w, h] = (_a = this.sprites.get(id)) !== null && _a !== void 0 ? _a : [0, 0, 0, 0];
