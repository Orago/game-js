(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../index.js", "../../util/meowtrix.js", "../../ecs/physics.js"], factory);
    }
    ...
    class RenderSystem extends index_js_1.Ecs.System {
        ...
        render2(entities) {
            ...
            for (const { render: comp, position } of entities) {
                ...
                current_matrix = meowtrix_js_1.Meowtrix.multiply(current_matrix, clone.getMatrix());
